                          ...
                          <div class="form-group">
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-7">
                                  ...
                                  <medium style="color:red" id="newPasswordRequirements" class="form-text text-muted"  maxlength="20"></medium>
                              </div>
                           </div>
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-7">
                                  ...
                                  <medium style="color:red" id="confirmPasswordRequirements" class="form-text text-muted"  maxlength="20"></medium>
                              </div>
                          </div>
