  ...
  <section id="container">
    <section id="main-content">
      <section class="wrapper">
        <h4 style="padding-bottom:10px; padding-top:10px; font-weight:bolder; font-family: 'Times New Roman', Times, serif;">LIST OF IN PROCESS AND CLOSED COMPLAINTS</h4>
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="content-panel">
              <section id="unseen">
                <table id="records" class="table table-bordered table-striped table-condensed">
                  ...
                  <?php
                     $query = mysqli_query($conn, "SELECT * FROM complaints WHERE (Status = 'In Process' OR Status = 'Closed') AND Flag = '0'  AND ComplaintType = 'Medical Report' ORDER BY 
                     CASE 
