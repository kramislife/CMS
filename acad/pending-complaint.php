  ...
  <section id="container">
    <section id="main-content">
      <section class="wrapper">
        <h4 style="padding-bottom:10px; padding-top:10px; font-weight:bolder; font-family: 'Times New Roman', Times, serif;">PENDING COMPLAINTS</h4>
        <div class="row mt">
          <div class="col-lg-12">
            ...
            <div class="content-panel">
              <section id="unseen">
                <table id="records" class="table table-bordered table-striped table-condensed">
                  ...
                  <tbody>
                    <?php
                    $query = mysqli_query($conn, "SELECT * FROM complaints WHERE (Status = 'Pending' OR Status IS NULL) AND isDeleted = '0'  AND (ComplaintType = 'Facility Issue' OR ComplaintType = 'Safety Concerns') ORDER BY RegDate DESC");
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form id="deleteForm" action="todays_data.php" method="POST">
                <div class="modal-body">
