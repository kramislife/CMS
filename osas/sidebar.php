...
$query = mysqli_query($conn, "SELECT UserImage FROM faculty_login WHERE UserID='" . $_SESSION['UserID'] . "'");
...
<aside>
  <div id="sidebar" class="nav-collapse">
    ...
    <ul class="sidebar-menu" id="nav-accordion">
      ...
      <?php
$query = mysqli_query($conn, "SELECT FullName FROM faculty_login WHERE UserID='" . $_SESSION['UserID'] . "'");
while ($row = mysqli_fetch_array($query)) {
?>
...
<?php } ?>
  ...
  input.addEventListener("change", function(event) {
    ...
    reader.onload = function(event) {
      ...
      xhr.open("POST", "../Faculty/update-pic.php");
      xhr.send(formData);
      ...
      xhr2.open("GET", "../Faculty/update-pic.php");
      xhr2.send();
    };
