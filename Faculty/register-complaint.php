...
if (isset($_POST['submit'])) {
  ...
  $stmt = mysqli_prepare($conn, "SELECT UserID, FullName, Email FROM faculty_login WHERE UserID = ?");
          ...
          <?php if($successmsg)
            ...
            <?php if($errormsg) { ?>
                ...
                <form class="form-horizontal style-form" method="post" name="complaint" enctype="multipart/form-data">
                  ...
                  <?php
                      $query = mysqli_query($conn, "SELECT * FROM faculty_login WHERE UserID='".$_SESSION['UserID']."'");
