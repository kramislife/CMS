                      ...
                      <form class="form-horizontal style-form" method="post" name="chngpwd" onSubmit="return valid();">
                          <div class="form-group">
                              ...
                              <div style="padding-top: 20px;" class="col-sm-7">
                                  <input type="password" name="oldPassword" required="required" class="form-control" maxlength="20">
                              </div>
                          </div>
                           ...
                           <div class="form-group">
                              ...
                              <div class="col-sm-7">
                                  <input type="password" name="newPassword" required="required" class="form-control" id="newPassword" maxlength="20">
                            ...
                            <div class="form-group">
                              ...
                              <div class="col-sm-7">
                                  <input type="password" name="confirmPassword" required="required" class="form-control" id="confirmPassword" maxlength="20">
