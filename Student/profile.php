...
$query=mysqli_query($conn, "UPDATE student_login SET ContactNo='$contactNumber', Email='$userEmail', Address='$address' WHERE UserID='".$_SESSION['UserID']."'");
      ...
      <div class="row mt">
        <div class="col-lg-12">
          ...
          <?php if($errormsg)
            ...
            <?php $query=mysqli_query($conn, "SELECT * FROM student_login WHERE UserID='".$_SESSION['UserID']."'");
          ...
          <h4 class="mb"><i class="fa fa-user"></i>&nbsp;&nbsp;<?php echo htmlentities($row['FullName']);?>'s Profile</h4>
            ...
            <form class="form-horizontal style-form" method="post" name="profile">
              <div class="form-group">
                <label class="col-sm-2 col-sm-2 control-label"><strong style="color: black">Student Number</strong></label>
                <div class="col-sm-4">
                  <input type="text" name="studentNumber" required="required" value="<?php echo htmlentities($row['StudentNumber']);?>" class="form-control" disabled>
                </div>
