...
$trainingData = [
        ...
        // Academic Issues
        ['complaint' => 'academics', 'type' => 'academic issues'],
        ['complaint' => 'I am struggling with my math assignments', 'type' => 'academic issues'],
        ['complaint' => 'Academic pressure is affecting my mental health', 'type' => 'academic issues'],
        ['complaint' => 'I find it hard to concentrate during lectures', 'type' => 'academic issues'],
        ['complaint' => 'Academic workload is overwhelming', 'type' => 'academic issues'],
        ['complaint' => 'I need help with improving my study habits', 'type' => 'academic issues'],
        ['complaint' => 'Academic competition is creating a stressful environment', 'type' => 'academic issues'],
        ['complaint' => 'I feel anxious about taking exams', 'type' => 'academic issues'],
        ['complaint' => 'Academic expectations are too high', 'type' => 'academic issues'],
        ['complaint' => 'I struggle to manage my time effectively for studies', 'type' => 'academic issues'],
        ['complaint' => 'Academic feedback is inadequate', 'type' => 'academic issues'],
        ['complaint' => 'I fear failure and its impact on my future', 'type' => 'academic issues'],
        ['complaint' => 'Academic resources at the library are insufficient', 'type' => 'academic issues'],
        ['complaint' => 'I have difficulty understanding certain subjects', 'type' => 'academic issues'],
        ['complaint' => 'Academic advisors are not readily available', 'type' => 'academic issues'],
        ['complaint' => 'I feel demotivated in my academic journey', 'type' => 'academic issues'],
        ['complaint' => 'Academic grading criteria are unclear', 'type' => 'academic issues'],
        ['complaint' => 'I struggle to balance academics with extracurricular activities', 'type' => 'academic issues'],
        ['complaint' => 'Academic lectures are monotonous and unengaging', 'type' => 'academic issues'],
        ['complaint' => 'I face challenges in adapting to the new learning environment', 'type' => 'academic issues'],
        ...
        ['complaint' => 'The school facilities are not wheelchair-accessible', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'There is a leakage in the school roof', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The school restroom is in terrible condition', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The classroom lights are flickering and need replacement', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'There are broken chairs in the school auditorium', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The air conditioning system in the library is not functioning', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The schools water supply is interrupted', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'There are cracks in the walls of the art room', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The school playground equipment is damaged and needs repair', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'There is a pest infestation in the cafeteria', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The music room floor is slippery and poses a safety risk', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The schools internet connection is unreliable', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'There is a plumbing issue in the science laboratory', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The schools fence is damaged and needs immediate repair', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'There is a shortage of desks in the classrooms', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The school building has cracked windows that need fixing', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'There are no proper storage facilities for students to keep their belongings', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The sports field has uneven ground, posing a risk of injury', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'There is no proper lighting in the school parking lot', 'type' => 'facilities and infrastructure problems'],
        ['complaint' => 'The schools fire alarm system is faulty and needs inspection', 'type' => 'facilities and infrastructure problems'],

        // Safety and Security Concerns
        ['complaint' => 'I witnessed a fight between students in the hallway', 'type' => 'safety and security concerns'],
        ['complaint' => 'There is a lack of security personnel on school premises', 'type' => 'safety and security concerns'],
        ['complaint' => 'The school gate is broken, posing a security risk', 'type' => 'safety and security concerns'],
        ['complaint' => 'I feel unsafe while walking home from school', 'type' => 'safety and security concerns'],
        ['complaint' => 'The schools CCTV cameras are not functioning', 'type' => 'safety and security concerns'],
        ['complaint' => 'There have been unauthorized individuals seen on school grounds', 'type' => 'safety and security concerns'],
        ['complaint' => 'The fire exits in the school are blocked', 'type' => 'safety and security concerns'],
        ['complaint' => 'There is a lack of proper lighting in the stairwells', 'type' => 'safety and security concerns'],
        ['complaint' => 'The schools emergency response plan is unclear', 'type' => 'safety and security concerns'],
        ['complaint' => 'I overheard students discussing potential violence in school', 'type' => 'safety and security concerns'],
        ['complaint' => 'The school does not have a visitor sign-in process', 'type' => 'safety and security concerns'],
        ['complaint' => 'I found a suspicious package on school premises', 'type' => 'safety and security concerns'],
        ['complaint' => 'There is a lack of proper fencing around the school', 'type' => 'safety and security concerns'],
        ['complaint' => 'I witnessed bullying incidents in the school bathroom', 'type' => 'safety and security concerns'],
        ['complaint' => 'The school does not conduct regular safety drills', 'type' => 'safety and security concerns'],
        ['complaint' => 'I feel uneasy due to the presence of unauthorized persons on campus', 'type' => 'safety and security concerns'],
        ['complaint' => 'The schools front door does not lock properly', 'type' => 'safety and security concerns'],
        ['complaint' => 'There is a lack of security measures during school events', 'type' => 'safety and security concerns'],
        ['complaint' => 'I heard rumors of a planned disruption during the upcoming school assembly', 'type' => 'safety and security concerns'],
        ['complaint' => 'The school does not have a clear protocol for handling emergencies', 'type' => 'safety and security concerns'],
