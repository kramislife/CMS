          ...
          <div class="content-panel">
              ...
              <table id="records" class="table table-bordered table-striped table-condensed">
                ...
                <?php
                  ...
                  $query = mysqli_query($conn, "SELECT * FROM complaints WHERE ComplaintID='$userId' AND isDeleted = '0' AND (Status IS NULL OR Status = 'Pending') ORDER BY 
                   RegDate DESC");
        ...
        <div class="modal fade" id="deleteModal" tabindex="-1" role="dialog" aria-labelledby="deleteModalLabel" aria-hidden="true">
          <div class="modal-dialog" role="document">
            <div class="modal-content">
              ...
              <form id="deleteForm" action="delete-complaint.php" method="POST">
                <div class="modal-body">
